  ...
  return (
    <div className="h-full flex flex-col bg-white border-l border-gray-100 w-full md:w-[380px] lg:w-[420px]">
      <div className="p-8 pb-4">
        <h2 className="text-2xl font-extrabold text-[#1A1D1F]">
          Current Order
        </h2>
                  ...
                  <div className="flex gap-4">
                    ...
                    <div className="flex-1 min-w-0">
                      <div className="flex justify-between items-start">
                        <div>
                          <h4 className="font-bold text-[#1A1D1F] truncate pr-2">
                            {item.name}
                          </h4>
                          {item.variationName && (
                      ...
                      <div className="flex items-center justify-between mt-3">
                        <div className="flex items-center bg-[#F0F2F5] rounded-xl p-1 gap-1">
                          ...
                          <span className="w-6 text-center text-sm font-extrabold text-[#1A1D1F]">
                            {item.quantity}
                          </span>
                          <button
                        ...
                        <div className="flex gap-1">
                              ...
                              <PopoverContent className="w-56 p-4 rounded-2xl shadow-xl border-none">
                                ...
                                <div className="space-y-2">
                                  {menuItem.extras.map((extra, idx) => {
                                    const isSelected = item.selectedExtras.some(
                                      (e) => e.name === extra.name,
                                    );
                                    return (
                                      <button
                          ...
                          <button
                            ...
                            onClick={() =>
                              onRemove(item.menuItemId, item.variationName)
                            }
                          >
      ...
      <div className="p-8 pt-6 space-y-6">
        <div className="space-y-3">
          <div className="flex justify-between text-gray-500 font-medium">
            <span>Subtotal</span>
            <span className="text-[#1A1D1F] font-bold">
